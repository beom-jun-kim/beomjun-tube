...
var addComment = function addComment(text, id) {
  var videoComments = document.querySelector(".video__comment-box ul");
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          text = textarea.value;
          videoId = videoContainer.dataset.id; // textarea에 아무것도 없으면 submit X
          if (!(text === "")) {
            _context.next = 6;
            break;
          }
