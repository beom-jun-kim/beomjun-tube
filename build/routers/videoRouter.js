...
videoRouter
  ...
  .get(_videoControllers.getUpload)
  .post(
    _middlewares.videoUpload.fields([
...
videoRouter
  ...
  .all(_middlewares.protectorMiddleware)
  .get(_videoControllers.getEdit)
  .post(_videoControllers.postEdit);
videoRouter
  .route("/:id([0-9a-f]{24})/delete")
  .all(_middlewares.protectorMiddleware)
  .get(_videoControllers.deleteVideo);
