...
userRouter.route("/edit-profile").all(_middlewares.protectorMiddleware).get(_userController.getEdit)

// 이름이 avatar인 파일 수락 , req에 보내진다
.post(_middlewares.avatarUpload.single("avatar"), _userController.postEdit); /* 옵션 : fields, none, single, arry (파일을 upload 시킨다)*/
