        ...
        while (1)
          switch ((_context2.prev = _context2.next)) {
            case 0:
              ...
              if (
                !(
                  sessionUsername !== formUsername && sessionEmail !== formEmail
                )
              ) {
                _context2.next = 12;
                break;
          ...
          switch ((_context5.prev = _context5.next)) {
            case 0:
              (_id = req.session.user._id),
                ...
                (newPasswordCheck = _req$body4.newPasswordCheck); // user를 찾으면 save() 함수 사용 가능
